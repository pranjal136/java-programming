/*
 * toString Method
 * The code given below contains the overridden toString() method to represent the 
 * Food object in a readable textual format.
Execute the code and observe the output.
Also, comment the toString() method and check the output.
 */
class Food {
