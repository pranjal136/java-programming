...
# Room:
- Room()
* Generate the roomNo using the static variable roomCounter. The value of roomNo 
* should start from 500 and should be incremented by 1 for the subsequent values. 
* Initialize the roomNoCounter in static block.
