/*
 * Given here is the Food class with equals method overridden to compare two Food objects 
 * based on their name and type.
Execute the given code, make necessary changes and observe the output.
 */
class Food {
