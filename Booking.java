...
* If the required number of seats are available, set the value of isBooked to true 
* and update the value of seatsAvailable accordingly. 
* The total number of seats available is 400 and should be initialized in static block.
...
class Booking{
    ...
    // Static block to initialize seatsAvailable to 400
    static {
        seatsAvailable = 400;
    }
...
class Tester {
    public static void main(String[] args) {
        ...
        Booking booking3 = new Booking("tony@email.com", 50); 
